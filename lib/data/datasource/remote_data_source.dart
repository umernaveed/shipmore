...
import 'package:we_ship_faas/data/models/send_referral_email_response/send_referral_email_response.dart';
...
class RemoteDataSourceImp implements RemoteDataSource {
  ...
  @override
  Future<BaseResponse<SendReferralEmailResponse>> sendReferralEmail(
    SendReferralEmailRequest request,
  ) async {
    final response = await _apiClient.postReq(
      EndPoints.sendReferralEmail,
      request.toJson(),
    );
    return _decode<BaseResponse<SendReferralEmailResponse>>(
      response,
      (json) => BaseResponse<SendReferralEmailResponse>(
        asBoolSafeCast(json['status']),
        json['message'],
        SendReferralEmailResponse.fromJson(
