...
class InvoiceDetailResponse {
  ...
  bool get isPaid {
    if (invoiceDetail.isEmpty) return false;
    return invoiceDetail.any((element) => element.status == 1);
  }

  bool get isNotPaid {
    if (invoiceDetail.isEmpty) return true;
    return invoiceDetail.any((element) => element.status == 0);
  }
